...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-algs/flexsearch.min.js');loadScript('/study-algs/en.search-data.min.91afc7d2fae7c81602954155a7a8ee45359ef0864aeed7d2e84f38c6422f4d51.js',function(){input.required=false;search();});}
