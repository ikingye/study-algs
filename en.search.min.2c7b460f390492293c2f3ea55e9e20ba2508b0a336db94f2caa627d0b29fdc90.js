...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-algs/flexsearch.min.js');loadScript('/study-algs/en.search-data.min.e50a89cf01abf6281612dbc8555132e20a9f9a8cc9a8725b81655dc305af0db7.js',function(){input.required=false;search();});}
