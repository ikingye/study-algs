...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-algs/flexsearch.min.js');loadScript('/study-algs/en.search-data.min.c09dda20b3d7cd6e6363cceb018109f532cbb5b4def0debac9adc67dcf61508e.js',function(){input.required=false;search();});}
